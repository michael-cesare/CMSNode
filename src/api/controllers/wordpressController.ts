...
export default async (app: Router) => {
  ...
  app.use(controllerPrefix, wordpressRouter)
  const wordpressController = new WordpressController()
  wordpressRouter.get('/menu', timeouMiddleware(wordpressController.HandleMenuRequest))
  wordpressRouter.get('/home', timeouMiddleware(wordpressController.HandleHomeRequest))
  wordpressRouter.get('/:postType/:postSlug?', timeouMiddleware(wordpressController.HandlePostPageRequest))
  wordpressRouter.get('/:pageSlug', timeouMiddleware(wordpressController.HandlePageRequest))
  wordpressRouter.get('/', timeouMiddleware(wordpressController.HandleHomeRequest))
}
